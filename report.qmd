...
if not category_6m.empty:
    ...
    bars = ax.barh(category_6m['category'], category_6m['price'], color='#90e0ef', height=0.6 )

    # Estilo do gráfico
    ax.set_title('Despesas recorrente por Categoria - Último Trimestre', weight='bold')
